...
HRESULT DemoApp::OnRender()
{
	...
	if (SUCCEEDED(hr))
	{
		...
		D2D1::Matrix3x2F translation2 = D2D1::Matrix3x2F::Translation(length,0);
		...
		*/
		...
		m_pRT->SetTransform(scale * translation *translation2);

		// 삼각형을 노란색으로 그림.
		m_pRT->FillGeometry(m_pObjectGeometry, m_pRedBrush);
